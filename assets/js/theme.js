...
function processFormSubmission(name, email, subject, message) {
    // code fragment
	var data = {
		service_id: 'service_d0fr3wc',
		template_id: 'template_os32l3f',
		user_id: 'xiTTNBLVR5ZWczOdE',
		template_params: {
			'name': name,
			'email': email,
			'subject': subject,
...
document.getElementById('tt-contact-form').addEventListener('submit', function(event) {
    // Prevent the default form submission behavior
    event.preventDefault();

    // Access form elements and retrieve form data
    const formData = new FormData(document.getElementById('tt-contact-form'));
    ...
    processFormSubmission(name, email, subject, message);
    
    // You can add additional logic here based on the form data
});
...
//     yellowStarSpan.className = 'yellow-star';
//     yellowStarSpan.innerHTML = '&#9733;'; // Yellow star symbol

//     // Get the paragraph element
//     const paragraph = document.getElementById('myParagraph');

//     // Append the yellow star span to the paragraph
//     paragraph.appendChild(yellowStarSpan);
// </script>